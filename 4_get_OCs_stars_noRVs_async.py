...
while i < largo:
	...
	#os.system('wget -O %s -t 1 --post-data="REQUEST=doQuery&LANG=ADQL&QUERY=SELECT TOP 10 * FROM gaiadr2.gaia_source" "http://gaia.ari.uni-heidelberg.de/tap/async" '%file_name)
	...
	if (not Cluster_Name in str(lista_clusters)) and mode == 'w_errors':
		...
		if A == True and B == True and C == True:
			print 'A and B and C '
			print 'wget -O %s -t 1 --post-data="REQUEST=doQuery&LANG=ADQL&QUERY=SELECT * FROM gaiadr2.gaia_source as gaia WHERE 1=CONTAINS(POINT(%s, gaia.ra, gaia.dec), CIRCLE(%s, %f, %f, %f )) AND gaia.pmra < %f  AND gaia.pmra > %f AND gaia.pmdec < %f  AND gaia.pmdec > %f AND gaia.parallax < %f  AND gaia.parallax > %f " "http://gaia.ari.uni-heidelberg.de/tap/async" '%(file_name, icrs_string, icrs_string, RA_cluster, DEC_cluster, search_rad, pmRA_cluster+sigma_num*epmRA_cluster, pmRA_cluster-sigma_num*epmRA_cluster, pmDEC_cluster+sigma_num*epmDEC_cluster, pmDEC_cluster-sigma_num*epmDEC_cluster, parallax_cluster+sigma_num*eparallax_cluster, parallax_cluster-sigma_num*eparallax_cluster ), '\n'
			os.system('wget -O %s -t 1 --post-data="REQUEST=doQuery&LANG=ADQL&QUERY=SELECT * FROM gaiadr2.gaia_source as gaia WHERE 1=CONTAINS(POINT(%s, gaia.ra, gaia.dec), CIRCLE(%s, %f, %f, %f )) AND gaia.pmra < %f  AND gaia.pmra > %f AND gaia.pmdec < %f  AND gaia.pmdec > %f AND gaia.parallax < %f  AND gaia.parallax > %f " "http://gaia.ari.uni-heidelberg.de/tap/async" '%(file_name, icrs_string, icrs_string, RA_cluster, DEC_cluster, search_rad, pmRA_cluster+sigma_num*epmRA_cluster, pmRA_cluster-sigma_num*epmRA_cluster, pmDEC_cluster+sigma_num*epmDEC_cluster, pmDEC_cluster-sigma_num*epmDEC_cluster, parallax_cluster+sigma_num*eparallax_cluster, parallax_cluster-sigma_num*eparallax_cluster ))

		elif A == True and B == True and C == False:
			print 'A and B not C '
			print 'wget -O %s -t 1 --post-data="REQUEST=doQuery&LANG=ADQL&QUERY=SELECT * FROM gaiadr2.gaia_source as gaia WHERE 1=CONTAINS(POINT(%s, gaia.ra, gaia.dec), CIRCLE(%s, %f, %f, %f )) AND gaia.pmra < %f  AND gaia.pmra > %f AND gaia.pmdec < %f  AND gaia.pmdec > %f " "http://gaia.ari.uni-heidelberg.de/tap/async" '%(file_name, icrs_string, icrs_string, RA_cluster, DEC_cluster, search_rad, pmRA_cluster+sigma_num*epmRA_cluster, pmRA_cluster-sigma_num*epmRA_cluster, pmDEC_cluster+sigma_num*epmDEC_cluster, pmDEC_cluster-sigma_num*epmDEC_cluster ), '\n'
			os.system('wget -O %s -t 1 --post-data="REQUEST=doQuery&LANG=ADQL&QUERY=SELECT * FROM gaiadr2.gaia_source as gaia WHERE 1=CONTAINS(POINT(%s, gaia.ra, gaia.dec), CIRCLE(%s, %f, %f, %f )) AND gaia.pmra < %f  AND gaia.pmra > %f AND gaia.pmdec < %f  AND gaia.pmdec > %f " "http://gaia.ari.uni-heidelberg.de/tap/async" '%(file_name, icrs_string, icrs_string, RA_cluster, DEC_cluster, search_rad, pmRA_cluster+sigma_num*epmRA_cluster, pmRA_cluster-sigma_num*epmRA_cluster, pmDEC_cluster+sigma_num*epmDEC_cluster, pmDEC_cluster-sigma_num*epmDEC_cluster ))


		elif A == True and B == False and C == True:
			print 'A not B and C '
			print 'wget -O %s -t 1 --post-data="REQUEST=doQuery&LANG=ADQL&QUERY=SELECT * FROM gaiadr2.gaia_source as gaia WHERE 1=CONTAINS(POINT(%s, gaia.ra, gaia.dec), CIRCLE(%s, %f, %f, %f )) AND gaia.pmra < %f  AND gaia.pmra > %f AND gaia.parallax < %f  AND gaia.parallax > %f " "http://gaia.ari.uni-heidelberg.de/tap/async" '%(file_name, icrs_string, icrs_string, RA_cluster, DEC_cluster, search_rad, pmRA_cluster+sigma_num*epmRA_cluster, pmRA_cluster-sigma_num*epmRA_cluster, parallax_cluster+sigma_num*eparallax_cluster, parallax_cluster-sigma_num*eparallax_cluster ), '\n'
			os.system('wget -O %s -t 1 --post-data="REQUEST=doQuery&LANG=ADQL&QUERY=SELECT * FROM gaiadr2.gaia_source as gaia WHERE 1=CONTAINS(POINT(%s, gaia.ra, gaia.dec), CIRCLE(%s, %f, %f, %f )) AND gaia.pmra < %f  AND gaia.pmra > %f AND gaia.parallax < %f  AND gaia.parallax > %f " "http://gaia.ari.uni-heidelberg.de/tap/async" '%(file_name, icrs_string, icrs_string, RA_cluster, DEC_cluster, search_rad, pmRA_cluster+sigma_num*epmRA_cluster, pmRA_cluster-sigma_num*epmRA_cluster, parallax_cluster+sigma_num*eparallax_cluster, parallax_cluster-sigma_num*eparallax_cluster ))

		elif A == True and B == False and C == False:
			print 'A not B not C '
			print 'wget -O %s -t 1 --post-data="REQUEST=doQuery&LANG=ADQL&QUERY=SELECT * FROM gaiadr2.gaia_source as gaia WHERE 1=CONTAINS(POINT(%s, gaia.ra, gaia.dec), CIRCLE(%s, %f, %f, %f )) AND gaia.pmra < %f  AND gaia.pmra > %f " "http://gaia.ari.uni-heidelberg.de/tap/async" '%(file_name, icrs_string, icrs_string, RA_cluster, DEC_cluster, search_rad, pmRA_cluster+sigma_num*epmRA_cluster, pmRA_cluster-sigma_num*epmRA_cluster ), '\n'
			os.system('wget -O %s -t 1 --post-data="REQUEST=doQuery&LANG=ADQL&QUERY=SELECT * FROM gaiadr2.gaia_source as gaia WHERE 1=CONTAINS(POINT(%s, gaia.ra, gaia.dec), CIRCLE(%s, %f, %f, %f )) AND gaia.pmra < %f  AND gaia.pmra > %f " "http://gaia.ari.uni-heidelberg.de/tap/async" '%(file_name, icrs_string, icrs_string, RA_cluster, DEC_cluster, search_rad, pmRA_cluster+sigma_num*epmRA_cluster, pmRA_cluster-sigma_num*epmRA_cluster ))
			...
			print 'wget -O %s -t 1 --post-data="REQUEST=doQuery&LANG=ADQL&QUERY=SELECT * FROM gaiadr2.gaia_source as gaia WHERE 1=CONTAINS(POINT(%s, gaia.ra, gaia.dec), CIRCLE(%s, %f, %f, %f ))" "http://gaia.ari.uni-heidelberg.de/tap/async" '%(file_name, icrs_string, icrs_string, RA_cluster, DEC_cluster, search_rad), '\n'
			os.system('wget -O %s -t 1 --post-data="REQUEST=doQuery&LANG=ADQL&QUERY=SELECT * FROM gaiadr2.gaia_source as gaia WHERE 1=CONTAINS(POINT(%s, gaia.ra, gaia.dec), CIRCLE(%s, %f, %f, %f ))" "http://gaia.ari.uni-heidelberg.de/tap/async" '%(file_name, icrs_string, icrs_string, RA_cluster, DEC_cluster, search_rad))
